    ...
    try:
        for i in range(len(historyr["part"])):
            ...
            for j in range(len(historyr["part"])):
                if j == 0 and k == 0: 
                    print(f" {historyr["produk"].ljust(12)} | {str(harga).ljust(13)} | {historyr["payer"].ljust(20)} |")
                    k = 1
                elif j == 0:
                    print(f" {historyr["produk"].ljust(12)} | {str(harga).ljust(13)} | {space.ljust(20)} |")
    ...
    try:
        for i in range(len(historyp["part"])):
            ...
            for j in range(len(historyp["part"][i]["produk"])):
                ...
                if j == 0 and k == 0: 
                    print(f" {item.ljust(12)} | {str(harga).ljust(13)} | {historyp["payer"].ljust(20)} |")
                    k = 1
                elif j == 0:
                    print(f" {item.ljust(12)} | {str(harga).ljust(13)} | {space.ljust(20)} |")
                else:
                    print(f"|   |              | {item.ljust(12)} | {str(harga).ljust(13)} | {space.ljust(20)} |")
            no += 1
